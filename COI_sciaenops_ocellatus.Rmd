...
```{r}
tree_6 <- read.tree("C:/witteLab/sebastes_github/Fasta_files/COI_sciaenops_ocellatus.fasta.treefile") #import tree into environment 
```
...
fasta_file <- read.FASTA("C:/witteLab/sebastes_github/Fasta_files/COI_sciaenops_ocellatus.fasta")
```
