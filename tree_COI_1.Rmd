...
lets see if I can manipulate the original fasta file with aligned COI First lests see if I can manipulate the tree directly
...
## ask if maybe I need to work with edge or edg length to change the branches. Or are thoes variables the certainty
```{r}
...
plot(tree_COI_a,
    align.tip.label = TRUE,
     cex = 0.8,
     no.margin = TRUE)
pdf("tree_COI_a.pdf", width = 14, height = 40) #rooted at acanthropagas latus 
```
